...
export const loader = async () => {
    ...
    // Strip Appwrite Document metadata ($id, $collection, etc.)
    // and provide safe defaults so Syncfusion grid never receives null/undefined
    const sanitizedUsers = users.map((doc) => ({
        accountId:  doc.accountId  ?? "",
        name:       doc.name       ?? "Unknown",
        email:      doc.email      ?? "",
        imageUrl:   doc.imageUrl   ?? "/assets/icons/users.svg",
